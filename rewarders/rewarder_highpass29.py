...
def calc_reward(rew, prev_obs, obs, prev_most_att_idx, prev_most_att, highpass, prev_opp_most_att_idx, prev_opp_most_att):
    ...
    if prev_obs and prev_most_att_idx:
        ...
        if owned_ball_team == 0 and prev_owned_ball_team == 1 :
            ...
            change_ball_owned_reward = -3.0
        elif owned_ball_team == 1 and prev_owned_ball_team == 1 and prev_owned_ball_player != owned_ball_player and owned_ball_player in prev_opp_most_att_idx and prev_opp_most_att > 0.4:
            change_ball_owned_reward = 1.0 #float(np.exp(prev_opp_most_att - 0.3) - 1)
        ...
        elif owned_ball_team == 0 and prev_owned_ball_team == 0 and highpass and active != 0 and prev_owned_ball_player != owned_ball_player and active in prev_most_att_idx and prev_most_att > 0.4:
            good_pass_counts = 1
            change_ball_owned_reward = 1.0 #float(np.exp(prev_most_att - 0.3))
