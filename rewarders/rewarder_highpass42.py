...
def calc_reward(rew, prev_obs, obs, prev_most_att_idx, prev_most_att, highpass, prev_opp_most_att_idx, prev_opp_most_att):
    ...
    if prev_obs:
        ...
        elif owned_ball_team == 0 and prev_owned_ball_team == 0 and owned_ball_player == prev_owned_ball_player:
            tired_reward = prev_active_tired - active_tired
    ...
    reward = 5.0*win_reward + 5.0*rew + 0.1*yellow_r + 0.001*ball_position_r + 0.1*change_ball_owned_reward + 0.1*safe_pass_reward + 0.03*tired_reward 
