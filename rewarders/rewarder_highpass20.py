...
def calc_reward(rew, prev_obs, obs, prev_most_att_idx, action):
    ...
    if prev_obs and prev_most_att_idx:
        ...
        if  prev_owned_ball_team == 0 and owned_ball_team == 0 and active_pos_x >= 0 and prev_owned_ball_player != owned_ball_player and active in prev_most_att_idx:
