...
def calc_reward(rew, prev_obs, obs, abc):
    ...
    if owned_ball_team == 0 and owned_ball_team_prev != 0 :
        change_ball_owned_reward = 1.0
    elif owned_ball_team == 1 and owned_ball_team_prev != 1 :
        change_ball_owned_reward = -1.0

            
    reward = 5.0*win_reward + 5.0*rew + 0.003*ball_position_r + yellow_r + 0.03*change_ball_owned_reward
