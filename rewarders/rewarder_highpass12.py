...
def calc_reward(rew, prev_obs, obs, player_att_idx, action):
    ...
    if  owned_ball_team_prev == 0 and owned_ball_team == -1 and active != 0:
    ...
    reward = 5.0*win_reward + 5.0*rew  + 0.3*yellow_r  + 0.1*change_ball_owned_reward + 0.5*empty_pass_reward + 0.1*ball_close_reward
