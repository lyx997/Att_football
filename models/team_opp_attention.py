...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_ball_k0 = nn.Linear(64,64)
        self.fc_ball_v0 = nn.Linear(64,64)
        
        self.fc_player_q0 = nn.Linear(64,64)
        ...
        self.fc_left_team_q0 = nn.Linear(64,64)
        ...
        self.fc_right_team_q0 = nn.Linear(64,64)
    ...
    def forward(self, state_dict):
        ...
        ball_k0 = self.fc_ball_k0(ball_state_embed)
        ball_v0 = self.fc_ball_v0(ball_state_embed)
        player_q0 = self.fc_player_q0(player_state_embed)
        player_v0 = self.fc_player_v0(player_state_embed)
        left_team_q0 = self.fc_left_team_q0(left_team_state_embed)
        left_team_v0 = self.fc_left_team_v0(left_team_state_embed)
        right_team_q0 = self.fc_right_team_q0(right_team_state_embed)
        right_team_v0 = self.fc_right_team_v0(right_team_state_embed)

        player_att0_ball = torch.bmm(player_q0, ball_k0.permute(0,2,1))/8
        player_att0_ball = F.softmax(player_att0_ball, dim=-1)

        ball_att0_player_embed = torch.bmm(player_att0_ball, ball_v0)
        player_att0_embed = self.norm_player_att0(torch.concat([player_v0, ball_att0_player_embed], dim=-1))

        left_att0_ball = torch.bmm(left_team_q0, ball_v0.permute(0,2,1))/8
        ...
        right_att0_ball = torch.bmm(right_team_q0, ball_v0.permute(0,2,1))/8
