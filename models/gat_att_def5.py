...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_cat = nn.Linear(64*3+48*3+96,arg_dict["lstm_size"])
    ...
    def forward(self, state_dict):
        ...
        cat = torch.cat([match_sit_embed, player_sit_embed, ball_sit_embed, 
                    left_closest_state_embed, right_closest_state_embed, left_player_atted_embed, right_ball_atted_embed], -1)
