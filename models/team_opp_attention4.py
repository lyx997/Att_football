...
################################################################
        ...
        self.fc_cat = nn.Linear(128+128+128+64,arg_dict["lstm_size"])
    ...
    def forward(self, state_dict):
        ...
        cat = torch.cat([match_sit_embed, player_sit_embed, ball_sit_embed, left_team_att2_player_embed], dim=2)
