...
class Model(nn.Module):
    ...
    def forward(self, state_dict):
        ...
        att3_player_ws = self.fc_att_attack_ws(all_team_att3_embed)
        ...
        att3_player_att = F.leaky_relu(self.fc_att_attack_as(att3_player_ws))
        ...
        att4_player_ws = self.fc_att_attack_ws(all_team_att4_embed)
        ...
        att4_player_att = F.leaky_relu(self.fc_att_attack_as(att4_player_ws))
