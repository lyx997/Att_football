...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_ball_state = nn.Linear(arg_dict["feature_dims"]["player_state"],64)
        self.fc_all_team_state = nn.Linear(arg_dict["feature_dims"]["player_state"],64)
        
        self.fc_att_attack_ws = nn.Linear(64,64)
        self.fc_att_attack_as = nn.Linear(128,1)

        self.fc_cat = nn.Linear(64*4,arg_dict["lstm_size"])
        ...
        self.norm_all_team_state = nn.LayerNorm(64)
    ...
    def forward(self, state_dict):
        ...
        player_att_embed = player_att_embed.view(horizon, batch, -1)

        cat = torch.cat([match_sit_embed, player_sit_embed, ball_sit_embed, player_att_embed], -1)
