...
class Model(nn.Module):
    ...
    def forward(self, state_dict):
        ...
        return prob, prob_m, v, h_out, [player_att1.view(horizon, batch, 11), left_team_att1.view(horizon, batch, 11, 11), player_att2.view(horizon, batch, 11), player_att2_.view(horizon, batch, 11)], \
                [ball_att1.view(horizon, batch, 11), right_team_att1.view(horizon, batch, 11, 11), ball_att2.view(horizon, batch, 11), ball_att2_.view(horizon, batch, 11)]
