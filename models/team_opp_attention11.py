...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.norm_player = nn.LayerNorm(arg_dict['feature_dims']["player_state"])
        self.norm_left = nn.LayerNorm(arg_dict['feature_dims']["player_state"])
        self.norm_right = nn.LayerNorm(arg_dict['feature_dims']["player_state"])
        ...
        self.fc_cat = nn.Linear(48*2+96*2,arg_dict["lstm_size"])
    ...
    def forward(self, state_dict):
        ...
        player_state_embed = self.norm_player(player_state)
        left_team_state_embed = self.norm_left(left_team_state)
        right_team_state_embed = self.norm_right(right_team_state)
