...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_att1_attack_ws = nn.Linear(arg_dict["feature_dims"]["player_state"],64, bias=False)
        ...
        self.fc_att1_defence_ws = nn.Linear(arg_dict["feature_dims"]["player_state"],64, bias=False)
