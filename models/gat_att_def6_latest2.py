...
class Model(nn.Module):
    ...
    def forward(self, state_dict):
        ...
        player_right_embed = torch.add(player_right_embed, player_state_embed)
        ...
        ball_left_embed = torch.add(ball_left_embed, ball_state_embed)
        ...
        right_left_embed = torch.add(right_left_embed, right_team_state_embed)
        ...
        left_right_embed = left_right_embed.view(horizon*batch, n_left, -1)#(1,11,64)
        left_right_embed = torch.add(left_right_embed, left_team_state_embed)
