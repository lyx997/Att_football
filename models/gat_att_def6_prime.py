...
class Model(nn.Module):
    ...
    def forward(self, state_dict):
        ...
        right_left_player_att1_ = torch.bmm(player_att2_.permute(0,2,1), left_team_att1_)
        ...
        left_right_ball_att1_ = torch.bmm(ball_att2_.permute(0,2,1), right_team_att1_)
        ball_att2_ = ball_att2_.view(horizon,batch, -1)
        ...
        return prob, prob_m, v, h_out, [] #[player_att1.squeeze(0).squeeze(1), right_left_player_att1.squeeze(0).squeeze(1).squeeze(0), player_att2.squeeze(0).squeeze(1)], \
                #[ball_att1.squeeze(0).squeeze(1), left_right_ball_att1.squeeze(0).squeeze(1).squeeze(0), ball_att2.squeeze(0).squeeze(1).squeeze(0)]
