...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_player = nn.Linear(arg_dict["def_feature_dims"]["player"],64)  
        self.fc_ball = nn.Linear(arg_dict["def_feature_dims"]["ball"],64)
        self.fc_left = nn.Linear(arg_dict["def_feature_dims"]["left_team"],48)
        self.fc_right  = nn.Linear(arg_dict["def_feature_dims"]["right_team"],48)
        self.fc_left_closest = nn.Linear(arg_dict["def_feature_dims"]["left_team_closest"],48)
        self.fc_right_closest = nn.Linear(arg_dict["def_feature_dims"]["right_team_closest"],48)
