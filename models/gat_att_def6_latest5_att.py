...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_player_state = nn.Linear(arg_dict["att_feature_dims"]["player_state"],64)
    ...
    def forward(self, state_dict):
        ...
        return prob, prob_m, v, h_out, [player_right_att1, left_right_team_att1, player_att2, player_att2_], [ball_left_att1, right_left_team_att1, ball_att2, ball_att2_]
    ...
    def make_batch(self, data):
        ...
        s = {
          ...
          "right_player_dis": torch.tensor(right_player_dis_batch, dtype=torch.float, device=self.device).permute(1,0,2),
          "left_ball_dis": torch.tensor(left_ball_dis_batch, dtype=torch.float, device=self.device).permute(1,0,2),
          "right_left_dis": torch.tensor(right_left_dis_batch, dtype=torch.float, device=self.device).permute(1,0,2,3),
          "left_right_dis": torch.tensor(left_right_dis_batch, dtype=torch.float, device=self.device).permute(1,0,2,3),
