...
class Model(nn.Module):
    ...
    def forward(self, state_dict):
        ...
        index1 = player_sort2_att_idx[:,0].unsqueeze(1)
        index2 = player_sort2_att_idx[:,1].unsqueeze(1)
        ...
        player_sort4_att_idx = torch.cat([player_sort2_att_idx, att1_player_att_idx, att2_player_att_idx], dim=1)
