...
class Model(nn.Module):
    ...
    def forward(self, state_dict):
        ...
        cat = torch.cat([player_sit_embed, ball_sit_embed, player_right_att_embed, left_player_att_embed, ball_left_att_embed, right_ball_att_embed], -1)

        out = F.relu(self.norm_cat(self.fc_cat(cat)))
        h_out = state_dict["hidden"]
