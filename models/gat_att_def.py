...
class Model(nn.Module):
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_att2_attack_ws = nn.Linear(128,128)
        self.fc_att2_attack_as = nn.Linear(256,1)

        self.fc_att1_defence_ws = nn.Linear(64,64)
        self.fc_att1_defence_as = nn.Linear(128,1)
        self.fc_att2_defence_ws = nn.Linear(128,128)
        self.fc_att2_defence_as = nn.Linear(256,1)
