...
################################################################
        ...
        self.fc_cat = nn.Linear(64*6,arg_dict["lstm_size"])
    ...
    def forward(self, state_dict):
        ...
        ball_right_att2 = F.gumbel_softmax(ball_right_att2, dim=-1, hard=True)#(1,1,10)
        ...
        ##---------------------------------------------------------------------------------       
        cat = torch.cat([match_sit_embed, player_sit_embed, ball_sit_embed, ball_left_att1_embed, left_team_att2_right_embed, right_team_att2_ball_embed], dim=2)
        ...
        return prob, prob_m, v, h_out, [ball_left_att1.squeeze().squeeze(), right_left_att2.squeeze().squeeze(), ball_right_att2.squeeze().squeeze()]
