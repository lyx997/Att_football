...
class FeatureEncoder:
    ...
    def encode(self, obs):
        ...
        player_state = np.concatenate((obs['left_team'][player_num]*2, player_direction*100, [player_speed*100, 0., player_tired, 1., 0., 0.]))
        ball_state = np.concatenate((obs['ball'][:-1]*2, ball_direction*20, [ball_speed*20, ball_distance*2, 0., 0., 0., 1.]))
