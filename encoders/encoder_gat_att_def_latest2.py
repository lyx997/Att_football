...
class FeatureEncoder:
    ...
    def encode(self, obs):
        ...
        player_state = np.concatenate((obs['left_team'][player_num]*2, player_direction, [player_speed*100, player_tired, 1., 0., 0.]))
        ball_state = np.concatenate((obs['ball'][:-1]*2, ball_direction, [ball_speed*100, 0., 0., 0., 1.]))
        ...
        left_team_state = np.concatenate((obs_left_team*2, left_team_direction, left_team_speed*100, \
                                         left_team_tired, left_team_onehot), axis=1)
        ...
        right_team_state = np.concatenate((obs_right_team*2, right_team_direction, right_team_speed*100, \
                                          right_team_tired, right_team_onehot), axis=1)
