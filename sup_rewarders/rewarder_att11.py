...
def calc_reward(rew, att_rew, prev_obs, obs, opp_num):
    ...
    if prev_obs:
        ...
        if prev_owned_ball_team == 1 and owned_ball_team != 0 and opp_num != None:
        ...
        elif prev_owned_ball_team == 0 and rew == 1:
            ...
            if prev_right_team_closest_distance <= 0.04:
                free_shoot_ball_reward = 0
            elif prev_right_team_closest_distance > 0.04 and prev_right_team_closest_distance <= 0.08:
                free_shoot_ball_reward = 1
            elif prev_right_team_closest_distance > 0.08 and prev_right_team_closest_distance <= 0.15:
                free_shoot_ball_reward = 2
            elif prev_right_team_closest_distance > 0.15:
                free_shoot_ball_reward = 3
    ...
    reward = 5.0*win_reward + 5.0*rew + 0.1*yellow_r + 0.001*ball_position_r + 0.1*att_rew + 0.01*change_ball_owned_reward + 0.01*not_owned_ball_reward + free_shoot_ball_reward
