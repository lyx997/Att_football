...
def calc_reward(rew, att_rew, prev_obs, obs):
    ...
    if prev_obs:
        ...
        if owned_ball_team == 0 and prev_owned_ball_team == 1 :
            ...
            owned_ball_player != 0 and prev_owned_ball_player != owned_ball_player :
            good_pass_counts = 1
    ...
    reward = 5.0*win_reward + 5.0*rew + 0.0001*yellow_r + 0.0001*ball_position_r + 0.1*att_rew #0.1*change_ball_owned_reward + 10*tired_reward 
